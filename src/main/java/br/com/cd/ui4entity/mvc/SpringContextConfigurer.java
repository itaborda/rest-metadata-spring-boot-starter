...
import br.com.cd.ui4entity.core.DefaultParserEngine;
import br.com.cd.ui4entity.core.ParserEngine;
import br.com.cd.ui4entity.core.SpringBeanFactoryDelegate;
...
public class SpringContextConfigurer implements BeanFactoryPostProcessor {
	...
	public SpringContextConfigurer(Class<? extends HandlerMethodReturnValueHandler> handlerReturnValueType, ParserEngine engine) {
		this.parserEngine = engine;
		this.handlerReturnValueType = handlerReturnValueType;
	}
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		...
		List<HandlerMethodReturnValueHandler> handlers = new LinkedList<>(handlerAdapter.getReturnValueHandlers());
	...
	private void decorateHandlers(List<HandlerMethodReturnValueHandler> handlers) {
		for (HandlerMethodReturnValueHandler handler : handlers) {
			...
			if (handlerReturnValueType.equals(handler.getClass())) {
				HandlerMethodReturnValueHandler decorator = new ValueOptionReturnValueHandler(new ControllerReturnValueHandler(handler,
						parserEngine));
