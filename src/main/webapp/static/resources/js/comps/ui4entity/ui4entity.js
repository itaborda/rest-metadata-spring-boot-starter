 ...
 * 
 */
var appModule = angular.module("ui4entity", [ 'ui.bootstrap' ]);
// var appModule = angular.module('UI4Entity', [ 'ui.multiselect' ]);
				...
				function($compile, $http) {
					...
					var UI4Entity = (function() {
						...
						this.make = function(jsonData, rootContext, $scope) {
							...
							var Resolvers = {
								...
								CheckboxResolver : function() {
									...
									this.resolveAjax = function(field, inputEl) {
										...
										var labelEl = spanEl.append("<label></label>");
									...
									this.resolveInternal = function(field, inputEl, spanEl, labelEl) {
										...
										if (!!field.metaData.select) {
											...
											if (isList || isMap) {
												...
												spanEl.attr("ng-repeat", "i in result.options." + field.name);
							...
							var rootDiv = Utils.createElement("div").attr("class", "ui4entity-form form-horizontal");
							...
							for (var g_i = 0; g_i < $scope.result.groupFields.length; g_i++) {
								...
								for (var f_i = 0; f_i < groupField.value.length; f_i++) {
									...
									var groupFields = groupDiv.append("div").attr(
											"class",
